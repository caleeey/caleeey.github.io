...
RNN의 상위 버전 GRU
pooling은 resizing & sampling을 의미
logits : name typically given to the output of the network [batch size : outputs num]
labels : you're providing [labels num : vector size]
number of labels you're providing = output of the network
